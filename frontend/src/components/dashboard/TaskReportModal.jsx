...
export default function TaskReportModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error("CREATE TASK REPORT ERROR:", err);
      ...
      >
        <div className="mb-5">
          ...
          <p className="text-sm text-gray-400 mt-1">
            Báo cáo của phòng ban gửi lãnh đạo theo chu kỳ nhiệm vụ
          </p>
        </div>
        ...
        <div className="rounded-2xl bg-blue-50 border border-blue-100 p-4 mb-5">
          ...
          <p className="text-sm text-blue-700 mt-1">
            Tỷ lệ hoàn thành sẽ được hệ thống tự ghi nhận theo trạng thái các phần việc nội bộ, không nhập thủ công.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              rows={5}
              placeholder="Nhập nội dung công việc đã thực hiện trong kỳ báo cáo..."
